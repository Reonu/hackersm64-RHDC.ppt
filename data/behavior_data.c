...
const BehaviorScript bhvMovingBarBlue[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_FLOAT(oCollisionDistance, 20000),
    CALL_NATIVE(bhv_moving_bar_init),
    BEGIN_LOOP(),
        LOAD_COLLISION_DATA(bar_blue_collision),
        CALL_NATIVE(bhv_moving_bar_loop),
    END_LOOP(),        
};
...
const BehaviorScript bhvSpring[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_HOLDABLE),
...
const BehaviorScript bhvPresentingDudeGuy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INT(oDrawingDistance, 20000),
    SCALE(/*hi*/ 0, /*cozies*/ 18),
    LOAD_ANIMATIONS(oAnimations, dudeguy_anims),
    CALL_NATIVE(bhv_presenting_dudeguy_init),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_presenting_dudeguy_loop),
    END_LOOP(),   
};
