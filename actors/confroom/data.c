...
f32 confroom_spaceDoorToHall[2][3] = {
    {   361.0669851303f,   131.7013859749f,   -99.0627110004f },
    {     2.5000000000f,     1.4156515598f,     0.7700467110f },
};
...
f32 confroom_spaceKitchen[2][3] = {
    {   772.7890968323f,   179.5816779137f,  3101.9878387451f },
    {     4.0266346931f,     1.9976686239f,     1.7677879333f },
};
...
f32 confroom_colCouch[2][3] = {
    {   536.1652374268f,    44.5305019617f,  2831.7991256714f },
    {     1.8917496204f,     0.7194517851f,     0.5908915997f },
};

f32 confroom_colFridge[2][3] = {
    {   405.1598548889f,    93.3932721615f,  2980.5093765259f },
    {     0.4203371704f,     0.9911558032f,     0.7765334845f },
};

f32 confroom_colWater[2][3] = {
    {   797.1671104431f,    97.7125406265f,  2840.0415420532f },
...
f32 confroom_pathAroundDesk[6][3] = {
    ...
    {   431.1867713928f,    -0.0002205372f,  1687.1044158936f },
...
f32 confroom_pathNextToReception[15][3] = {
    ...
    {   644.1879749298f,    -0.0003099442f,  2236.0239028931f },
    {   650.4146575928f,    -0.0003099442f,  2045.2484130859f },
    ...
    {   918.3348655701f,    -4.3546777219f,  2563.9020919800f },
    {   780.8092117310f,    -0.0007271767f,  2533.1701278687f },
    {   680.4683685303f,   -24.4187712669f,  2543.3353424072f },
};

f32 confroom_pathNextToElevator[7][3] = {
    {   804.9373626709f,    -0.0007271767f,  2775.6729125977f },
    {  1442.8459167480f,    -0.0007271767f,  2795.7420349121f },
    {  1434.8815917969f,    -0.0007271767f,  2503.7260055542f },
    {   989.7584915161f,    -0.0007271767f,  2519.3258285522f },
    {   909.7113609314f,    -0.0007271767f,  2339.4567489624f },
    {   684.0522289276f,    -0.0007271767f,  2348.2738494873f },
    {   709.9884986877f,    -0.0007271767f,  2602.3796081543f },
};
...
ConfroomObjectSpawn spawn_dudeGuySplineWater = {
    {   660.6778144836f,    -0.0002861023f,  2197.1984863281f },
    { 0x0000, 0x18ec, 0x0000 },
    MODEL_DUDEGUY,
    (uintptr_t)bhvSplineDudeGuy,
    0,
...
ConfroomObjectSpawn spawn_dudeGuySplineReception = {
    {   190.8307075500f,    -0.0006794930f,  2696.5642929077f },
    { 0x0000, 0x18ec, 0x0000 },
    MODEL_DUDEGUY,
    (uintptr_t)bhvSplineDudeGuy,
    0,
...
ConfroomObjectSpawn spawn_dudeguyConfroomSitting = {
    {   142.9838418961f,   -12.1267236769f,   233.1617593765f },
    { 0x0000, 0x0000, 0x0000 },
    MODEL_DUDEGUY,
    (uintptr_t)bhvDudeGuy,
    NPC_ANIM_BORED,
...
ConfroomObjectSpawn spawn_splineStopperWater = {
    {   798.2933998108f,    -0.0004053116f,  2816.5334701538f },
    { 0x0000, 0x0000, 0x0000 },
    MODEL_NONE,
    (uintptr_t)bhvSplineStopper,
    NPC_ANIM_SHELF,
...
ConfroomObjectSpawn spawn_splineStopperReception = {
    {   634.9288940430f,    -0.0005483627f,  2175.5737304688f },
    { 0x0000, 0x0000, 0x0000 },
    MODEL_NONE,
    (uintptr_t)bhvSplineStopper,
    NPC_ANIM_RECEPTION,
...
ConfroomObjectSpawn spawn_introKathy = {
    {  -281.6431283951f,    -0.0007152557f,  2737.6806259155f },
    { 0x0000, -0x4000, 0x0000 },
    MODEL_CHATTY_KATHY,
...
f32 directionalLightOrigin[3] = { -3345.5493927002f,   297.9038715363f,   862.2272491455f };

f32 directionalLightDestination[3] = { -3345.5493927002f,     0.0000476837f,  -483.7607383728f };
