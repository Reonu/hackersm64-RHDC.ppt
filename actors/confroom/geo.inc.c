...
const GeoLayout confroom_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 785, 130, 3354, confroom_coffee_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, confroom_coffee_mesh_layer_5),
			GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, confroom_coffee_mesh_layer_2),
		GEO_CLOSE_NODE(),
