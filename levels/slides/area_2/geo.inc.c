...
const GeoLayout slides_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE_DECAL, 28, -905, -37, slides_dl_graph_001_mesh_layer_2),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE_DECAL, -519, -331, 21, slides_dl_graph_002_mesh_layer_2),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, slides_dl_slide2_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, slides_dl_slide2title_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
