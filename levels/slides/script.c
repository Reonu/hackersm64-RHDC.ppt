...
const LevelScript level_slides_entry[] = {
	...
	AREA(10, slides_area_10),
		...
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BAR, 346, -1374, 21, 0, 0, 0, (210 << 16) | (254 << 8), bhvMovingBarPink),
		OBJECT(MODEL_BAR, -236, -1374, 21, 0, 0, 0, (210 << 16) | (240 << 8), bhvMovingBarRed),
		OBJECT(MODEL_BAR, -854, -1374, 21, 0, 0, 0, (190 << 16) | (110 << 8), bhvMovingBarBlue),
		OBJECT(MODEL_STAR, 1298, 705, 33, 0, 0, 0, (0x0A << 24), bhvStar),
		OBJECT(MODEL_BAR, -1859, 489, 21, 0, 0, -90, (210 << 16) | (110 << 8) | (200), bhvMovingBar),
