...
const LevelScript level_slides_entry[] = {
	...
	AREA(18, slides_area_18),
		...
		OBJECT(MODEL_PURPLE_SWITCH, -1560, -544, 0, 0, 0, 0, (SWITCH_COLOR_GREEN << 24), bhvFloorSwitchHiddenObjects),
		OBJECT(MODEL_PURPLE_SWITCH, 80, -486, 0, 0, 0, 0, (SWITCH_COLOR_ORANGE << 24), bhvFloorSwitchHiddenObjects),
		OBJECT(MODEL_PURPLE_SWITCH, -1989, -544, 0, 0, 0, 0, (SWITCH_COLOR_ORANGE << 24), bhvFloorSwitchHiddenObjects),
