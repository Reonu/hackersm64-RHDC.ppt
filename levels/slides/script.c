...
const LevelScript level_slides_entry[] = {
	...
	AREA(10, slides_area_10),
		...
		OBJECT(MODEL_NONE, 1906, 772, 33, 0, 0, 0, (0x0A << 24), bhvStartingPoint),
	...
	AREA(15, slides_area_15),
		...
		WARP_NODE(0x01, LEVEL_SLIDES, 0x0B, 0x02, WARP_NO_CHECKPOINT),
		WARP_NODE(0x02, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -1975, -1278, 0, 0, 0, 0, (0x01 << 24), bhvCheckpoint),
		OBJECT(MODEL_NONE, 502, 328, 0, 0, 0, 0, (0x02 << 24), bhvCheckpoint),
		OBJECT(MODEL_NONE, 502, -1249, 0, 0, 0, 0, (0x03 << 24), bhvCheckpoint),
		OBJECT(MODEL_SILVER_STAR, -516, 1321, 37, 0, 0, 0, (0x01), bhvStar),
		OBJECT(MODEL_SILVER_STAR, -516, -623, 37, 0, 0, 0, (0x01), bhvStar),
		OBJECT(MODEL_SILVER_STAR, 1200, 1033, 0, 0, 0, 0, (0x01), bhvStar),
		OBJECT(MODEL_STAR, 1738, -1038, 37, 0, 0, 0, (0x0F << 24), bhvStar),
		OBJECT(MODEL_NONE, -1839, 390, 37, 0, 0, 0, (0x01), bhvStartingPoint),
	...
	AREA(17, slides_area_17),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x01, LEVEL_SLIDES, 0x0B, 0x02, WARP_NO_CHECKPOINT),
		WARP_NODE(0x02, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_SPRING, -1771, -1205, 0, 0, 0, 0, (SPRING_RED << 16), bhvSpring),
		OBJECT(MODEL_SPRING, -927, -580, 0, 0, 0, 0, (SPRING_YELLOW << 16), bhvSpring),
		OBJECT(MODEL_STAR, 1728, 792, 0, 0, 0, 0, (0x11 << 24), bhvStar),
	...
	AREA(18, slides_area_18),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x01, LEVEL_SLIDES, 0x0B, 0x02, WARP_NO_CHECKPOINT),
		WARP_NODE(0x02, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BAR, 1517, -1189, 0, 0, 0, 0, (BAR_COLOR_GRAY << 24) | (BAR_START_MAX << 16) | (120 << 8), bhvMovingBarWithSwitch),
		OBJECT(MODEL_BAR, 517, -1189, 0, 0, 0, 0, (BAR_COLOR_GREEN << 24) | (BAR_START_MAX << 16) | (120 << 8), bhvMovingBarWithSwitch),
		OBJECT(MODEL_BAR, -483, -1189, 0, 0, 0, 0, (BAR_COLOR_ORANGE << 24) | (BAR_START_MIN << 16) | (120 << 8), bhvMovingBarWithSwitch),
		OBJECT(MODEL_STAR, 2113, 52, 0, 0, 0, 0, (0x12 << 24), bhvStar),
		OBJECT(MODEL_NONE, -2042, -1189, 0, 0, 0, 0, 0x00000000, bhvStartingPoint),
		OBJECT(MODEL_PURPLE_SWITCH, -1602, 417, 0, 0, 0, 0, (SWITCH_COLOR_GRAY << 24), bhvFloorSwitchHiddenObjects),
		OBJECT(MODEL_PURPLE_SWITCH, -1560, -1189, 0, 0, 0, 0, (SWITCH_COLOR_GREEN << 24), bhvFloorSwitchHiddenObjects),
		OBJECT(MODEL_PURPLE_SWITCH, -1258, -395, 0, 0, 0, 0, (SWITCH_COLOR_GREEN << 24), bhvFloorSwitchHiddenObjects),
		OBJECT(MODEL_PURPLE_SWITCH, 80, -486, 0, 0, 0, 0, (SWITCH_COLOR_ORANGE << 24), bhvFloorSwitchHiddenObjects),
	...
	AREA(3, slides_area_3),
		...
		OBJECT(MODEL_NONE, -1644, -1191, 0, 0, 0, 0, 0x00000000, bhvStartingPoint),
	...
	AREA(5, slides_area_5),
		...
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_DONUT1, -1728, -439, 19, 0, 0, 0, (0 << 24) | (40 << 16), bhvDonut1),
		OBJECT(MODEL_DONUT2, -1, -439, 19, 0, 0, 0, (90 << 24) | (50 << 16), bhvDonut2),
		OBJECT(MODEL_DONUT3, 1752, -439, 19, 0, 0, 0, (180 << 24) | (60 << 16), bhvDonut3),
	...
	AREA(7, slides_area_7),
		...
		OBJECT(MODEL_BAR, -618, -1529, 21, 0, 0, 0, (110 << 16) | (254 << 8), bhvMovingBar),
		OBJECT(MODEL_NONE, -1796, -89, 21, 0, 0, 0, (50 << 16) | (254 << 8), bhvStartingPoint),
	...
	AREA(8, slides_area_8),
		...
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_CHECKPOINT_FLAG, 1606, -432, 69, 0, 0, 0, 0x00000000, bhvCheckpointFlag),
		...
		OBJECT(MODEL_NONE, 2026, -952, 69, 0, 0, 0, 0x00000000, bhvStartingPoint),
