...
const LevelScript level_slides_entry[] = {
	...
	AREA(10, slides_area_10),
		...
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BAR_GREEN, -1125, -1388, 21, 0, 0, 0, (120 << 16) | (254 << 8), bhvMovingBarGreen),
		OBJECT(MODEL_BAR_GREEN, 742, -279, 21, 0, 0, 0, (120 << 16) | (254 << 8), bhvMovingBarGreen),
	...
	AREA(3, slides_area_3),
		...
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BAR, -1289, -1283, 21, 0, 0, 0, (40 << 16), bhvMovingBar),
		OBJECT(MODEL_BAR, -939, -1283, 21, 0, 0, 0, (80 << 16), bhvMovingBar),
	...
	AREA(8, slides_area_8),
		...
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BAR_YELLOW, -1433, -1387, 21, 0, 0, 0, (120 << 16) | (230 << 8) | (100), bhvMovingBar),
		OBJECT(MODEL_BAR_RED, -1133, 420, 21, 0, 0, 180, (120 << 16) | (230 << 8) | (30), bhvMovingBarRed),
		OBJECT(MODEL_BAR_YELLOW, -833, -1387, 21, 0, 0, 0, (120 << 16) | (230 << 8) | (80), bhvMovingBar),
		OBJECT(MODEL_BAR_YELLOW, -233, -1387, 21, 0, 0, 0, (120 << 16) | (230 << 8) | (160), bhvMovingBar),
		OBJECT(MODEL_BAR_YELLOW, 367, -1387, 21, 0, 0, 0, (120 << 16) | (230 << 8) | (180), bhvMovingBar),
		OBJECT(MODEL_BAR_YELLOW, 967, -1387, 21, 0, 0, 0, (120 << 16) | (230 << 8) | (254), bhvMovingBar),
		OBJECT(MODEL_BAR_RED, -533, 420, 21, 0, 0, 180, (120 << 16) | (230 << 8) | (60), bhvMovingBarRed),
		OBJECT(MODEL_BAR_RED, 67, 420, 21, 0, 0, 180, (120 << 16) | (230 << 8) | (76), bhvMovingBarRed),
		OBJECT(MODEL_BAR_RED, 667, 420, 21, 0, 0, 180, (120 << 16) | (230 << 8) | (130), bhvMovingBarRed),
		OBJECT(MODEL_BAR_RED, 1267, 420, 21, 0, 0, 180, (120 << 16) | (230 << 8) | (230), bhvMovingBarRed),
	...
	AREA(9, slides_area_9),
		...
		OBJECT(MODEL_BAR_RED, -518, -1388, 21, 0, 0, 0, (130 << 16) | (254 << 8), bhvMovingBarRed),
