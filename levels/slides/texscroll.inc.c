...
void scroll_slides_dl_slide6TitleMesh_mesh_layer_0_vtx_1() {
	int i = 0;
	int count = 4;
	int width = 64 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(slides_dl_slide6TitleMesh_mesh_layer_0_vtx_1);
...
void scroll_slides() {
	...
	scroll_slides_dl_slide6TitleMesh_mesh_layer_0_vtx_1();
};
