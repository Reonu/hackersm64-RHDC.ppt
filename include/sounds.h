...
enum SoundBank {
    ...
    SOUND_BANK_CUSTOM_FOREGROUND3,
    SOUND_BANK_CUSTOM_BACKGROUND1,
...
#define SOUND_BANK_CATHY SOUND_BANK_CUSTOM_FOREGROUND1
#define SOUND_BANK_MATTY SOUND_BANK_CUSTOM_FOREGROUND2
#define SOUND_BANK_OFFICE SOUND_BANK_CUSTOM_FOREGROUND3
...
#define SOUND_BANKS_FOREGROUND (\
    ...
    (1 << SOUND_BANK_VOICE) |\
    (1 << SOUND_BANK_MENU) |\
    (1 << SOUND_BANK_CUSTOM_FOREGROUND1) |\
    (1 << SOUND_BANK_CUSTOM_FOREGROUND2) |\
    (1 << SOUND_BANK_CUSTOM_FOREGROUND3))
#else
#define SOUND_BANKS_FOREGROUND (\
    (1 << SOUND_BANK_ACTION) |\
    (1 << SOUND_BANK_VOICE) |\
...
#define SOUND_MARIO_OKEY_DOKEY                   /* 0x20210001 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x21, 0xFF, 0) // unused
...
// Cathy
// lead ins
#define SOUND_CATHY_LEAD_IN_GET_A_LOAD_OF_THIS          SOUND_ARG_LOAD(SOUND_BANK_CATHY,  0, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_LEAD_IN_HAPPY_HOUR                  SOUND_ARG_LOAD(SOUND_BANK_CATHY,  1, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_LEAD_IN_KELLY_WAS_LIKE              SOUND_ARG_LOAD(SOUND_BANK_CATHY,  2, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_LEAD_IN_MITCHELL                    SOUND_ARG_LOAD(SOUND_BANK_CATHY,  3, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_LEAD_IN_YOURE_NEVER_GONNA_BELIEVE   SOUND_ARG_LOAD(SOUND_BANK_CATHY,  4, 0x80, SOUND_DISCRETE)
// mumbles
#define SOUND_CATHY_MUMBLE_AND_ILL_BE_NICE              SOUND_ARG_LOAD(SOUND_BANK_CATHY,  5, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_MUMBLE_FOO_FOO_CACHOO               SOUND_ARG_LOAD(SOUND_BANK_CATHY,  6, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_MUMBLE_PADDLE_DRUN                  SOUND_ARG_LOAD(SOUND_BANK_CATHY,  7, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_MUMBLE_UGH_RIGHT                    SOUND_ARG_LOAD(SOUND_BANK_CATHY,  8, 0x80, SOUND_DISCRETE)
// questions
#define SOUND_CATHY_QUESTION_PLAN_STAN                  SOUND_ARG_LOAD(SOUND_BANK_CATHY,  9, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_QUESTION_WAIT_SHH_HES_COMING        SOUND_ARG_LOAD(SOUND_BANK_CATHY, 10, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_QUESTION_WHAT_ABOUT_YO              SOUND_ARG_LOAD(SOUND_BANK_CATHY, 11, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_QUESTION_WHAT_SAY_YOU               SOUND_ARG_LOAD(SOUND_BANK_CATHY, 12, 0x80, SOUND_DISCRETE)
// coffee steal
#define SOUND_CATHY_COFFEE_STEAL_HOWD_YOU_KNOW          SOUND_ARG_LOAD(SOUND_BANK_CATHY, 13, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_COFFEE_STEAL_ILL_TAKE_THAT          SOUND_ARG_LOAD(SOUND_BANK_CATHY, 14, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_COFFEE_STEAL_SUCH_A_SWEETHEART      SOUND_ARG_LOAD(SOUND_BANK_CATHY, 15, 0x80, SOUND_DISCRETE)
// coffee sip
#define SOUND_CATHY_COFFEE_SIP_AHHH                     SOUND_ARG_LOAD(SOUND_BANK_CATHY, 16, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_COFFEE_SIP_MMM                      SOUND_ARG_LOAD(SOUND_BANK_CATHY, 17, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_COFFEE_SIP_GOOD_MORNIN              SOUND_ARG_LOAD(SOUND_BANK_CATHY, 18, 0x80, SOUND_DISCRETE)
// intro
#define SOUND_CATHY_INTRO_WAKE_UP                       SOUND_ARG_LOAD(SOUND_BANK_CATHY, 19, 0x80, SOUND_DISCRETE)
#define SOUND_CATHY_INTRO_YOU_LOOK_TERRIBLE             SOUND_ARG_LOAD(SOUND_BANK_CATHY, 20, 0x80, SOUND_DISCRETE)


// Matty
// lead ins
#define SOUND_MATTY_LEAD_IN_BANDWIDTH        SOUND_ARG_LOAD(SOUND_BANK_MATTY,  0, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_LEAD_IN_LOW_HANGIN_FRUIT SOUND_ARG_LOAD(SOUND_BANK_MATTY,  1, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_LEAD_IN_RUN_PAST_YOU     SOUND_ARG_LOAD(SOUND_BANK_MATTY,  2, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_LEAD_IN_THERE_YOU_ARE    SOUND_ARG_LOAD(SOUND_BANK_MATTY,  3, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_LEAD_IN_WHEELHOUSE       SOUND_ARG_LOAD(SOUND_BANK_MATTY,  4, 0x80, SOUND_DISCRETE)
// mumbles
#define SOUND_MATTY_MUMBLE_DUCKS_IN_A_ROW     SOUND_ARG_LOAD(SOUND_BANK_MATTY,  5, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_MUMBLE_FIRST_AND_FOREMOST SOUND_ARG_LOAD(SOUND_BANK_MATTY,  6, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_MUMBLE_SYNERGY            SOUND_ARG_LOAD(SOUND_BANK_MATTY,  7, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_MUMBLE_THE_NEW_NORMAL     SOUND_ARG_LOAD(SOUND_BANK_MATTY,  8, 0x80, SOUND_DISCRETE)
// questions
#define SOUND_MATTY_QUESTION_CIRCLE_BACK     SOUND_ARG_LOAD(SOUND_BANK_MATTY,  9, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_QUESTION_HIT_ME          SOUND_ARG_LOAD(SOUND_BANK_MATTY, 10, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_QUESTION_HOWS_THAT_SOUND SOUND_ARG_LOAD(SOUND_BANK_MATTY, 11, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_QUESTION_TRIGGER         SOUND_ARG_LOAD(SOUND_BANK_MATTY, 12, 0x80, SOUND_DISCRETE)
// coffee steal
#define SOUND_MATTY_COFFEE_STEAL_GOT_MY_BACK SOUND_ARG_LOAD(SOUND_BANK_MATTY, 13, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_COFFEE_STEAL_PROMOTION   SOUND_ARG_LOAD(SOUND_BANK_MATTY, 14, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_COFFEE_STEAL_I_LOVE_YOU  SOUND_ARG_LOAD(SOUND_BANK_MATTY, 15, 0x80, SOUND_DISCRETE)
// coffee sip
#define SOUND_MATTY_COFFEE_SIP_MMM           SOUND_ARG_LOAD(SOUND_BANK_MATTY, 16, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_COFFEE_SIP_OOH           SOUND_ARG_LOAD(SOUND_BANK_MATTY, 17, 0x80, SOUND_DISCRETE)
#define SOUND_MATTY_COFFEE_SIP_SMACK         SOUND_ARG_LOAD(SOUND_BANK_MATTY, 18, 0x80, SOUND_DISCRETE)

// Office sfx
#define SOUND_OFFICE_MGS                                SOUND_ARG_LOAD(SOUND_BANK_OFFICE, 0, 0x80, SOUND_DISCRETE)
#define SOUND_OFFICE_SFX_DONE_MAKING_COFFEE             SOUND_ARG_LOAD(SOUND_BANK_OFFICE, 1, 0x80, SOUND_DISCRETE)
#define SOUND_OFFICE_SFX_OPE_YOURE_BACK                 SOUND_ARG_LOAD(SOUND_BANK_OFFICE, 2, 0x80, SOUND_DISCRETE)
#define SOUND_OFFICE_SFX_TURN_THE_LIGHTS_OFF            SOUND_ARG_LOAD(SOUND_BANK_OFFICE, 3, 0x80, SOUND_DISCRETE)
#define SOUND_OFFICE_SFX_WALKING_IN                     SOUND_ARG_LOAD(SOUND_BANK_OFFICE, 4, 0x80, SOUND_DISCRETE)
#define SOUND_OFFICE_SFX_YOU_NEED_COFFEE_NOW            SOUND_ARG_LOAD(SOUND_BANK_OFFICE, 5, 0x80, SOUND_DISCRETE)
#define SOUND_OFFICE_SFX_COFFEEMACHINE                  SOUND_ARG_LOAD(SOUND_BANK_OFFICE, 6, 0x80, SOUND_DISCRETE)
#define SOUND_OFFICE_SFX_END_OF_PRESENTATION            SOUND_ARG_LOAD(SOUND_BANK_OFFICE, 7, 0x80, SOUND_DISCRETE)
#define SOUND_OFFICE_SFX_JUST_A_NIGHTMARE               SOUND_ARG_LOAD(SOUND_BANK_OFFICE, 8, 0x80, SOUND_DISCRETE)
