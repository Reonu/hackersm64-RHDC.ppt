...
enum NpcAnims {
    ...
    NPC_ANIM_PHONE,
    NPC_ANIM_SHELF,
    NPC_ANIM_AWAITING_RESPONSE_MALE,
    NPC_ANIM_AWAITING_RESPONSE_FEMALE,
    NPC_ANIM_EATING,
    NPC_ANIM_BORED,
    NPC_ANIM_STEAL_COFFEE,
    NPC_ANIM_INTRO_WAKE_UP,
    NPC_ANIM_INTRO_YOU_LOOK_TERRIBLE,
    NPC_ANIM_RECEPTION,
    NPC_ANIM_SPRINTING,
...
enum PresentingDudeguyActions {
    PRESENTING_DUDEGUY_START,
    PRESENTING_DUDEGUY_WALKING_IN_FIRST_TIME,
    PRESENTING_DUDEGUY_WAITING_FOR_PLAYER_TO_SIT,
    PRESENTING_DUDEGUY_WAITING_FOR_PLAYER_TO_LEAVE_CONFROOM,
    PRESENTING_DUDEGUY_WAITING_FOR_PLAYER_TO_COME_BACK,
    PRESENTING_DUDEGUY_PRESENTING,
    PRESENTING_DUDEGUY_GET_UP,
    PRESENTING_DUDEGUY_WALKING_IN_AGAIN,
    PRESENTING_DUDEGUY_TURN_OFF_LIGHTS,
    PRESENTING_DUDEGUY_ENDING,
};
