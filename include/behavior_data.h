...
extern const BehaviorScript bhvMovingBar[];
extern const BehaviorScript bhvDonut1[];
extern const BehaviorScript bhvDonut2[];
extern const BehaviorScript bhvDonut3[];
extern const BehaviorScript bhvDonut4[];
extern const BehaviorScript bhvDonut5[];
extern const BehaviorScript bhvDonut6[];
...
extern const BehaviorScript bhvMovingBarBlue[];
...
extern const BehaviorScript bhvDudeGuy[];
extern const BehaviorScript bhvPresentingDudeGuy[];
extern const BehaviorScript bhvSplineDudeGuy[];
...
extern const BehaviorScript bhvCoffeeMachine[];
